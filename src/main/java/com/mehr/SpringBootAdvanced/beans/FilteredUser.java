...
public class FilteredUser implements Serializable {
    ...
    public FilteredUser(int userId, String firstName, String surname, LocalDate dateOfBrith, String username, String password) {
        this.userId = userId;
    ...
    public FilteredUser(User user) {
        ...
        this.dateOfBrith= user.getDateOfBrith();
